...
### Future Plans
1. **Support for Multiple TG Bots**: Enable interaction and coordination among multiple Telegram bots for more complex and interconnected workflows.
2. **Plugin Development**: Introduce a plugin system to support additional features, such as image parsing and analysis, enhancing the bot's functionality.
3. **Enhanced Customization Options**: Expand user-specific customization capabilities for a more tailored experience.
4. **Improved Memory Storage**: Enhance the memory and retrieval system to better recall past interactions and user-specific data.
5. **Broader Model Support**: Extend compatibility with more AI models to provide flexibility in performance and capabilities.
